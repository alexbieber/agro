...
export default function WhatsAppButton({ className }: { className?: string }) {
  ...
  return (
    <a
      ...
      className={cn(
        "fixed bottom-20 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-whatsapp text-white shadow-lg transition-transform hover:scale-105 active:scale-95 md:bottom-6 md:h-14 md:w-14",
